...
export const CalendarGrid = ({ currentDate, events, view, onEventClick, onDateClick, onEventUpdate }: CalendarGridProps) => {
    // Route to different view components
    switch (view) {
        case "month":
            return <MonthView currentDate={currentDate} events={events} onEventClick={onEventClick} onDateClick={onDateClick} onEventUpdate={onEventUpdate} />;
        case "week":
